...
{
    public partial class RealEstateDbTestContext : DbContext
    {
        public RealEstateDbTestContext()
        {
        }

        public RealEstateDbTestContext(DbContextOptions<RealEstateDbTestContext> options)
            : base(options)
        {
        }
